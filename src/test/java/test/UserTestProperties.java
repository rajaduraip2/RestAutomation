...
public class UserTestProperties {
    ...
    public void  testPostUser()
    {
        ...
        Response createUserResponse= UserEndPoints2.createUser(userPayLoad);
    ...
    public void  testGetUser()
    {
        ...
        Response getUserResponse=UserEndPoints2.getUser(userName);
    ...
    public void  testUpdateUser()
    {
        ...
        Response postUserResponse=UserEndPoints2.updateUser(userName,userPayLoad);
    ...
    public void  testDeleteUser()
    {
        ...
        String userName=userPayLoad.getUsername();
        Response deleteUserResponse=UserEndPoints2.deleteUser(userName);
